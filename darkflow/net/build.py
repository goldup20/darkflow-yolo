...
class TFNet(object):
	...
	_TRAINER = dict({
		'rmsprop': tft.train.RMSPropOptimizer,
		'adadelta': tft.train.AdadeltaOptimizer,
		'adagrad': tft.train.AdagradOptimizer,
		'adagradDA': tft.train.AdagradDAOptimizer,
		'momentum': tft.train.MomentumOptimizer,
		'adam': tft.train.AdamOptimizer,
		'ftrl': tft.train.FtrlOptimizer,
		'sgd': tft.train.GradientDescentOptimizer
	})
